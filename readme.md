...
### 1.1.8
* Improved Allow Request logic

### 1.1.7
* Added style support for challenge page (you can now control its appearance with custom styles in your theme's stylesheet)

### 1.1.6
* Added fallback handling to clean up unverified accounts
