...
class ds_get_options {
	public function process( $ip, &$stats = array(), &$options = array(), &$post = array() ) {
		...
		if ( !is_numeric( $ansa['ds_cache'] ) ) {
			$ansa['ds_cache'] = 25;
		}
		if ( !is_numeric( $ansa['ds_cache_em'] ) ) {
			$ansa['ds_cache_em'] = 10;
		}
		if ( !is_numeric( $ansa['ds_good'] ) ) {
			$ansa['ds_good'] = 2;
		}
		if ( !is_numeric( $ansa['ds_hist'] ) ) {
			$ansa['ds_hist'] = 25;
		}
		...
		ds_set_options( $ansa ); // new version, need to set the new options
